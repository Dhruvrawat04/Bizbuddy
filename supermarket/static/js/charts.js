...
function displaySegmentationResults(data) {
    ...
    // Debug element hidden - only console logging
    ...
    clusters.forEach(cluster => {
        ...
        card.className = 'card mb-3 revealed';
...
function displayBusinessInsights(insights) {
    ...
    // Debug: log insights to console only (no on-page display)
    try {
    ...
    insights.forEach((insight, index) => {
        const card = document.createElement('div');
        card.className = 'insight-card card mb-3 revealed';
        ...
        // Process the insight text to handle markdown bold syntax
        let processedInsight = insight;
        // Convert **text** to <strong>text</strong>
        processedInsight = processedInsight.replace(/\*\*(.*?)\*\*/g, '<strong>$1</strong>');
            ...
            <div class="card-body">
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-grow-1">
                        <div class="markdown-content">${processedInsight}</div>
                    </div>
                </div>
            </div>
        `;
